...
This document is not intended as conversion document for mass consumption by Savage Worlds fans and gamers.
...
This document also includes additional content that was adapted from the link:https://peginc.com/savage-settings/savage-pathfinder/[Pathfinder for Savage Worlds] rules set.
****
...
He may only choose and use one such Edge per session. His command radius is equal to 5".
