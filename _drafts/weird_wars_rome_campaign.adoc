...
This document is not intended as conversion document for mass consumption by Savage Worlds gamers.
This document was drafted with the intent to support my own Weird Wars Rome campaign that will be played using SWADE.
I encourage Savage Worlds enthusiasts of all stripes to purchase Weird Wars Rome (2013) 
...
He may only choose and use one such Edge per session. His command radius is equal to 5".footnote:[What modifiers affect this range? Maybe the Charismatic edge?] 
...
+
*Special rules*:
Sins: Priests of Mithras are subject to the usual rules for sinning described in Savage Worlds.
...
For reference see link:https://en.wikipedia.org/wiki/Auxilia#Recruitment,_ranks_and_pay[Auxilia].
