...
*   **Level:** 1
*   **XP:** 0
*   **Party Bonds:** With Tejon - body servants to the Bandit Lord; with Dorgan (survivors of the Great March)

### Attributes (SCORE | MOD | GS | TF)

*   **Strength:** ` 15 | +2 | 7 | 20 `
*   **Dexterity:** ` 10 | 0 | 5 | 16 `
*   **Constitution:** ` 8 | -1 | 4 | 13 `
*   **Intelligence:** ` 9 | 0 | 4 | 14 `
*   **Perception:** ` 13 | +1 | 6 | 20 `
*   **Willpower:** ` 7 | -1 | 3 | 11 `
*   **Charisma:** ` 16 | +2 | 8 | 20 `
...
## Abilities
* **Silvered Tongue** - At 1st level you have the gift of the  gab, and are skilled in the art of soliciting rumours,  gossip, and other intel. 
Gain advantage when using the Gather Information skill, when performing to entertain or inspire, and when using either the Persuasion or Deception skill (choose one).
* **Inspire Greatness** - At 1st level, your unifying presence builds trust within the party and inspires its companions to moments of greatness. 
